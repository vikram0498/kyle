...
@section('email-content')
    <h4 style="font-family: 'Barlow', sans-serif; color: #464B70; font-weight: 700; font-size: 18px;margin-top: 0;">Congratulations!</h4>
    
    <p style="line-height: 25.5px; font-family: 'Nunito Sans', sans-serif; color: #464B70; margin-bottom: 27px;">You've successfully registered your {{ config('constants.app_name') }} Account.</p>
    
    <p style="line-height: 25.5px; font-family: 'Nunito Sans', sans-serif; color: #464B70; margin-bottom: 27px;">One final step! Click the link below to confirm your email and set your password.</p>
