            ...
            <div>
                ...
                <div class="items-center justify-between p-2 sm:flex">
                        ...
                        <div class="my-4 sm:my-0">
                            <div class="lg:hidden">
                                <span class="space-x-2"><div class="flex justify-between">
<!-- Previous Page Link -->
...
<div class="w-32 flex justify-between items-center relative px-4 py-2 border border-gray-300 text-sm leading-5 font-medium rounded-md text-gray-400 bg-gray-50">
    Next
    <svg class="h-5 w-5 stroke-current inline" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path>
                            ...
                            <div class="justify-center hidden lg:flex">
                                <span><div class="flex overflow-hidden border border-gray-300 divide-x divide-gray-300 rounded pagination">
    <!-- Previous Page Link -->
    ...
    <div class="divide-x divide-gray-300">
        ...
        <!-- Array Of Links -->
                        ...
                        <button wire:click="gotoPage(1)" id="pagination-desktop-page-1" class="-mx-1 relative inline-flex items-center px-4 py-2 text-sm leading-5 font-medium text-gray-700 hover:text-gray-500 focus:z-10 focus:outline-none focus:border-blue-300 focus:shadow-outline-blue active:bg-gray-100 active:text-gray-700 transition ease-in-out duration-150 bg-gray-200">
            1
            </button>
                            </div>

    <!-- Next Page Link -->
        <button class="relative inline-flex items-center px-2 py-2 -ml-px text-sm font-medium leading-5 text-gray-500 bg-white " disabled=""><span>»</span></button>
    </div>
</span>
                            </div>
                        </div>
