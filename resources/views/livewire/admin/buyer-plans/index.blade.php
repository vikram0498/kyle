        ...
        <div class="card">
            <div class="card-body">
                ...
                @if($formMode)
                    ...
                    @include('livewire.admin.buyer-plans.form')

                @elseif($viewMode)

                    @livewire('admin.buyer-plans.show', ['plan_id' => $plan_id])

                @else
                    <div wire:loading wire:target="create" class="loader"></div>
                    <div class="card-title top-box-set">
                        <h4 class="card-title-heading">{{__('cruds.buyer_plan.title')}} {{ __('global.list') }}</h4>
                    ...
                    <div class="table-responsive search-table-data">
                            ...
                            @livewire('admin.buyer-plans.buyer-plan-table') 
