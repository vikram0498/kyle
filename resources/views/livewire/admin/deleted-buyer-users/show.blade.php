<div>
    ...
    @php 
        $buyerFlagCount = $details->redFlagedData()->where('buyer_user.status', 0)->count();
    @endphp
    ...
    <table class="table table-design mb-4">
        <tr>
            ...
            <td class="remove-white-space">{{ $userDetail ? $userDetail->name : 'N/A' }}</td>
        </tr>
        <tr>
            <th width="25%">{{ __('cruds.buyer.fields.email')}}</th>
            <td class="remove-white-space">{{ $userDetail ? $userDetail->email : 'N/A' }}</td>
        </tr>
        <tr>
            <th width="25%">{{ __('cruds.buyer.fields.phone')}}</th>
            <td class="remove-white-space"> {{ $userDetail ? $userDetail->phone : 'N/A' }}</td>
        </tr>
        <tr>
            <th width="25%">Description</th>
            <td class="remove-white-space"> {{ $userDetail ? $userDetail->description : 'N/A'}}</td>
        </tr>
        <tr>
