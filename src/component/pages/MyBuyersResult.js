...
const MyBuyersResult = ({buyerData,setBuyerData,buyerType,activeTab,pageNumber,getFilterResult}) =>{
            ...
            <div className="property-critera">
                <div className="row">
                    ...
                    <div className='property_loder'>
                        <div className="data-loader" ><img src="/assets/images/data-loader.svg" className='m-0 w-100 h-100'/></div>
                    </div>:''}
                    {buyerData.length > 0 ? (
                        <>
