...
Route::group(['middleware' => ['api','auth:sanctum']],function () { 
    ...
    //Start edit buyer
    Route::get('edit-buyer/{buyer_property_id?}', [BuyerController::class, 'edit']);
    Route::get('get-buyer-properites', [BuyerController::class, 'getBuyerProperties']);
    Route::get('get-buyer-property-detail/{id}', [BuyerController::class, 'getBuyerPropertiesDetails']);

    Route::get('edit-buyer-form-element-values', [CommanController::class, 'editBuyerFormElementValues']);
    Route::post('update-single-buyer-details/{buyer_property_id}', [BuyerController::class, 'updateSingleBuyerDetails']);
    //End edit buyer
    ...
    // Route::group(['middleware' => ['role:' . implode(',', [config('constants.roles.seller')])]], function () {
        ...
        Route::post('deals/show/{id}', [SearchBuyerController::class, 'sellerDealDetail']);
    ...
    // Route::group(['middleware' => ['role:' . implode(',', [config('constants.roles.buyer')])]], function () {
        ...
        Route::post('buyer-deals/make-favourite', [SearchBuyerController::class, 'updateFavouriteStatus']);
